...
const dropdownMenu = shallowRef([
  ...
  {
    link: 'FAQs',
    href: 'https://ableproadmin.com/vue/pages/faq'
  },
  {
    link: '404 Error',
    href: 'https://ableproadmin.com/vue/pages/error'
  },
  {
    link: 'Register',
    href: 'https://ableproadmin.com/vue/auth/register1'
  },
  {
    link: 'Contact us',
    href: 'https://ableproadmin.com/vue/pages/contact-us'
  },
  {
    link: 'Landing',
    href: 'https://ableproadmin.com/vue'
  },
  {
    link: 'Reset Password',
    href: 'https://ableproadmin.com/vue/auth/reset-pwd1'
  },
  {
    link: 'Pricing',
    href: 'https://ableproadmin.com/vue/pages/pricing1'
  },
  {},
  {
    link: 'Forgot Password',
    href: 'https://ableproadmin.com/vue/auth/forgot-pwd1'
  },
  {
    link: 'Privacy policy',
    href: 'https://ableproadmin.com/vue/pages/privacy-policy'
  },
  {},
  {
    link: 'Verification code',
    href: 'https://ableproadmin.com/vue/auth/code-verify1'
  },
  {
    link: 'Construction',
    href: 'https://ableproadmin.com/vue/pages/construction'
  },
  {},
  {},
  {
    link: 'Coming soon',
    href: 'https://ableproadmin.com/vue/pages/comingsoon1'
  }
]);
function openNewTab() {
  const url = '/components/buttons'; // Replace with your URL
    ...
    <v-row class="ma-0">
      <v-col cols="12" lg="4" class="pa-0">
        <div class="megamenu-banner pa-9">
          <h2 class="text-h2 text-surface mb-1">Explore Components</h2>
          <p class="text-h6 text-surface mb-0">Try Able Pro's component pages to check how it feels and suits as per your need.</p>
          <div class="d-flex justify-between align-end">
            <v-btn @click="openNewTab" variant="flat" class="scale-hover" rounded="md">
              View All
